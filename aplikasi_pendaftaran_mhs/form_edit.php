...
$sql = "SELECT *FROM mhs_baru WHERE id='$id'";
...
<center>
    <div class="pict">
    <img src="img/smk9.png" width="100" height="130">
        <img src="img/uny.png" width="130" height="130">
        </div>
  ...
  <tr>
                        ...
                        <tr>
                            ...
                            <td><strong>:</strong></td>
                            <td><input type="radio" name="jenis_kel" value="laki-laki" <?php echo ($mhs == 'laki-laki') ? "checked": ''; ?>>Laki - Laki
                            <input type="radio" name="jenis_kel" value="perempuan" <?php echo ($mhs== 'perempuan') ? "checked": ''; ?>>Perempuan
                        </td>
                        ...
                        <tr>
                            ...
                            <td>:<td>
                                ...
                                <option <?php echo ($mhs ['agama'] == 'konghucu') ? "selected": ""; ?>value="konghucu">konghucu</option>
                                <option <?php echo ($mhs ['agama'] == 'aliran kepercayaan') ? "selected": ""; ?>value="aliran kepercayaan">aliran kepercayaan</option>
                            </select>
    </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td><strong>:</strong></td>
                            <td><input type="text" name="asal_sekolah" value="<?php echo $mhs['asal_sekolah'] ?>"></td>
                        </tr>
